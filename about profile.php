                                ...
                                <div class="home-deta iq-mt-90">
                                    <div class="row">
                                        ...
                                        if (isset($_SESSION['userUid'])) {
                                            ...
                                            if (!$result) {
                                                echo "error fetching about users";
                                            } else {
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    if ($row['gender'] == 'M')
                                                        ...
                                                        $gender = "Female";
                                                    echo '
                                                    <div class=" about col-md-8 content-deta">
                                                        <div class="main-title">
                                                            <small>' . $lang['know'] . '</small>
                                                            <h2 class="display-4 iq-tw-8 iq-font-purple">' . $lang['aboutnmepage'] . '</h2>
                                                        </div>
                                                        <p class="iq-tw-4 iq-mt-10 iq-mb-20">
                                                            ' . $row['description'] . '
                                                        </p>
                                                        <ul class="contact-info">
                                                            <li> <span class="iq-tw-6">' . $lang['aboutname'] . ' :</span> ' . $username . '</li>
                                                            <li> <span class="iq-tw-6">' . $lang['date'] . ' :</span> ' . $row['birthDate'] . '</li>
                                                            <li> <span class="iq-tw-6">' . $lang['email'] . ' :</span> <a href="#" style="background: #e87e16 ; padding:10px; color:white"> ' . $row['emailUsers'] . '</a></li>
                                                            <li> <span class="iq-tw-6">' . $lang['phone'] . ' :</span> (+216)' . $row['phone'] . '</li>
                                                            <li> <span class="iq-tw-6">' . $lang['address'] . ' :</span> From ' . $row['Address'] . '</li>
                                                            <li><span class="iq-tw-6">' . $lang['gender'] . ' :</span> ' . $gender . '</li>
                                                        </ul>
                                                    </div>';
                                                }
                                            }
